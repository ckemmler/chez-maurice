...
- **The mail conversation's yes triggers no reading yet** (lot 4): Maurice says "from the next night on" and the night does not read. Tested with a stubbed tool, not yet on the real thread.
